...
public class JhipocApp {

    private static final Logger log = LoggerFactory.getLogger(JhipocApp.class);

    private final Environment env;

    public JhipocApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipocApp.class);
